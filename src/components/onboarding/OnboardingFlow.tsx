...
function getOnboardingSteps() {
  ...
  const steps = [
            ...
            <div className="p-4 bg-secondary rounded-lg border border-border">
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-foreground0 mt-1">Select area · {cmd}{shift}2</div>
                </div>
              </div>
            </div>
            <div className="p-4 bg-secondary rounded-lg border border-border">
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-foreground0 mt-1">Entire screen · {cmd}{shift}F</div>
                </div>
              </div>
            </div>
            <div className="p-4 bg-secondary rounded-lg border border-border">
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-foreground0 mt-1">Single window · {cmd}{shift}D</div>
                </div>
              </div>
            </div>
            <div className="p-4 bg-secondary rounded-lg border border-border">
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-foreground0 mt-1">Extract text · {cmd}{shift}O</div>
                </div>
              </div>
            </div>
          </div>
    ...
    // Permissions step only for macOS
    ...(isMac ? [{
      id: "permissions",
      ...
      content: (
        <div className="space-y-4 text-center">
          <p className="text-sm text-muted-foreground text-pretty">
            Press <kbd className="px-2 py-1 bg-secondary border border-border rounded text-foreground font-mono text-xs tabular-nums">{cmd}{shift}2</kbd> to capture a region, or use the buttons on the main screen.
          </p>
...
export function OnboardingFlow({ onComplete }: OnboardingFlowProps) {
  ...
  // Safe check if currentStep is out of bounds (though it shouldn't be)
